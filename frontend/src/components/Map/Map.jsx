      ...
      <Fragment>
        ...
        >
          ...
          <LayersControl.Overlay name="Cơ sở y tế" checked>
            <LayerGroup>{add_Data2("Cơ sở y tế", hospital2, hospital)}</LayerGroup>
          </LayersControl.Overlay>
  ...
  const popupSidiebar = () => {
    return (
      <Sidebar
        ...
        onHide={() => {setVisibleSlide(false); setCurrentPlaceID(null); map.flyTo(center, zoom);}}
        ...
        <div className="formgrid grid" key={currentPlace?._id}>
          ...
          >
            <Image
              ...
              src={currentPlace?.imgURL || "https://i.pinimg.com/originals/72/66/03/7266036c9f3383d21730484150602f01.gif"}
  ...
  const popupSidiebar2 = () => {
    return (
      <Sidebar
        ...
        onHide={() => {setVisibleSlide2(false); setCurrentPlaceID(null); map.flyTo(center, zoom);}}
        ...
        <div className="formgrid grid" key={currentPlace2?._id}>
          ...
          >
            <Image
              ...
              src={currentPlace2?.type === "Ăn uống" ? food3 : currentPlace2?.type === "Trạm xăng dầu" ? oil3 : currentPlace2?.type === "Cơ sở y tế" ? hospital3 : atm3 || "https://i.pinimg.com/originals/72/66/03/7266036c9f3383d21730484150602f01.gif"}
